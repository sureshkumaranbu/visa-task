...
var HolidayService = (function () {
    function HolidayService(_http) {
        this._http = _http;
        this._holidayUrl = 'https://holidayapi.com/v1/holidays?country=US&year=2015&key=d39e8157-5d9d-4196-a5dd-310c01d59229';
    }
    ...
    HolidayService.prototype.handleError = function (error) {
        console.error(error);
